...
export class AuthProjectService {
  ...
  public deletePrice(project:ProjectPayload): Observable<any> {
    return this.http.post(`/users/project/deletePrice`, project)
  }
  ...
  public deleteBid(bid:BidPayload): Observable<any> {
    return this.http.post(`/users/project/deleteBid`, bid)
  }
